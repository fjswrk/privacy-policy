...
This privacy policy applies to the Health Data Export App app (hereby referred to as "Application") for mobile devices
that was created by FJSW (hereby referred to as "Service Provider") as an Ad Supported service. This service is intended
for use "AS IS".
...
them at hirfujisawa@gmail.com and they will respond in a reasonable time.
...
Service Provider (hirfujisawa@gmail.com) so that they will be able to take the necessary actions.
...
contact the Service Provider via email at hirfujisawa@gmail.com.
